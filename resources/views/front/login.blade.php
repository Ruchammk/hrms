...
<div class="container">
    ...
    <div class="reg-block">
        ...
        <div class="reg-block-header">
            ...
            <h2><!-- <img src="{{$appSetting->logo_image_url}}" height="50px"> -->Sign in to HRMS</h2>
        ...
        <div class="tab-v2">
            ...
            <div class="tab-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <!-- <button type="submit" class="btn-u btn-block input-group" id="submitbutton"
                                    ...
                                    <button type="submit" class="btn-u btn-block input-group" id="submitbutton"
                                            onclick="login(); return false;">Continue</button>
                ...
                <!-- <div class="form-actions rem">
                    <a href="/public/" class="btn btn-sm btn-block btn-rounded btn-primary text-uppercase">Go to Frontend Site</a>
                </div> -->
            </div>
        </div>
...
{{--
function checkEmailRoleFirst(){
  $.easyAjax({
      url: "{!! route('login_role_check') !!}",
      type: "POST",
