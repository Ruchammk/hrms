...
class Employee extends \Eloquent implements Authenticatable, CanResetPasswordContract
{
...
/*
    protected $fillable = [
        ...
        // 'employee_role',
        //
        // 'self_help_group_contribution',
        // 'additional_self_help_group_contribution',
...
*/
        ...
        'employee_immigration_status',
        'employee_identification_number',
        'employee_passport_number',
        'employee_passport_doi',
    ...
    public function getWorkDurationAttribute()
    {
        ...
        $string = ($diff->d == 0 && $diff->m == 0 && $diff->y == 0) ? 'Joined Today' : $string;
